...
/**
 * @description Overwrites resetAllToDefault method and removes the search suggestions
 */
ATCOMP._resetToDefault = function(){
	let formerResetDefaults = window.resetAllToDefault;
	window.resetAllToDefault = function(...args){
		localStorage.removeItem(ATCOMP._settings._values._ids.checkbox);
		ATCOMP._settings._getCheckbox().checked = false;
		return formerResetDefaults(args);
	}
}
